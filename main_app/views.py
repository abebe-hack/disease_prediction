...
def pviewprofile(request, patientusername):
    ...
    if request.method == "GET":
        ...
        return render(
            request, "patient/view_profile/view_profile.html", {"puser": puser}
        )
...
def pconsultation_history(request):
    ...
    if request.method == "GET":
        ...
        return render(
            request,
            "patient/consultation_history/consultation_history.html",
...
def dconsultation_history(request):
    ...
    if request.method == "GET":
        ...
        return render(
            request,
            "doctor/consultation_history/consultation_history.html",
            {"consultation": consultationnew},
        )
...
def dviewprofile(request, doctorusername):
    ...
    if request.method == "GET":
        ...
        return render(
            request,
            "doctor/view_profile/view_profile.html",
            {"duser": duser, "rate": r},
        )
...
def consult_a_doctor(request):
    ...
    if request.method == "GET":
        ...
        return render(
            request, "patient/consult_a_doctor/consult_a_doctor.html", {"dobj": dobj}
        )
